...
public interface UserProvider {
     ...
     * Retrieves a user based on their email.
     *
     * @param emailPart The partial email of the user to be searched
     * @return A user with the specified email
     */

    List<User> findAllUsersByEmailPart(String emailPart);

    /**
     * Retrieves all users older than a specific date.
     *
     * @param date The date to compare with
     * @return A list of users whose birthdate is before the specified date
     */
    List<User> findAllUsersOlderThanDate(LocalDate date);
